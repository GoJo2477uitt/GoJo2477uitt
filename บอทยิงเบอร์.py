...
token = "None" # โทเค็นบอท
server = 11462449332921937416 # <--- ไอดีเซิร์ฟเวอร์ของเรา
spam_max = 100 # <--- จำนวนการยิงเบอร์สูงสุด
title_ui = "Flexzy Store | บริการยิงเบอร์" # <--- ชื่อ Title ในที่กรอกเบอร์และจำนวน (Modal)
des = "เพิ่มคําอธิบาย" # ข้อความอธิบายในส่วนของ Embed
